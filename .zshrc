...
export ZSH="/Users/zoe.blanco/.oh-my-zsh"
...
# Setting this variable when =random will cause zsh to load
# a theme from this variable instead of looking in $ZSH/themes/
# If set to an empty array, this variable will have no effect.
# _RANDOM_CANDIDATES=( "robbyrussell" "agnoster" )
